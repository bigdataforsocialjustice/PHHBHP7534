...
---
# Part I
Here is the link to part I of the [exam](https://github.com/bigdataforsocialjustice/PHHBHP7534/blob/main/assignment/phhbhp_exam1.docx).
...
To download the data click the downarrow as shown below

```{r knit-button, echo=FALSE, out.width="100%"}
knitr::include_graphics("/slides/img/01/download_git.png", error = FALSE)
```
